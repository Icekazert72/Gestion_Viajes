...
<body>
    <div class="slider_cont">
        <div class="title">
            <h1>Terminal de <p style=" margin-left: 10px;"> Forama</p>
            </h1>
        </div>
        <div class="img">
            <div class="img_container">
                <img src="../../img/index/images.png" alt="">
            </div>
        </div>
    </div>

    <div class="container rutas_agen">
        <div class="title ">
            <h4>Tickets y Rutas</h4>
        </div>
        <div class="buscador">
            <form action="" method="get">
                <div class="time">
                    <div><label for=""><strong>Seleciona la hora</strong></label></div>
                   <div> <input type="time" class="form-control" name="" id=""></div>
                </div>
            </form>
        </div>
        <div class="rutas_card">

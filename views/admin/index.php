                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control campo-validacion" required min="1">
                                    <span class="input-group-text icono-validacion"><i class="fas fa-circle"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control campo-validacion" required pattern="[0-9]{8}[A-Za-z]">
                                    <span class="input-group-text icono-validacion"><i class="fas fa-circle"></i></span>
                                </div>
                            </div>
    ...
    <footer class="footer-navbar">
        <nav class="navbar-dock">
            ...
            <div class="logo-section">
                <img src="../../img/index/Logo_viages.png" alt="Logo del sistema">
            </div>
